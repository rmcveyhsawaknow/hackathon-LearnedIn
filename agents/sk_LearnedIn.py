"""The following demonstrates using Azure AI Services via Azure AI Foundry SDK with Semantic Kernel to create and run an agent in just a few lines of code. 
The Agent script allows for Github Models for quick development tasks, or Azure AI Services for production workloads."""
